(asdf:defsystem "quasar-tests"
  ...
  :components ((:file "control-plane-tests")
               ...
               (:file "autodig-delegated-registration-tests")
               (:file "autodig-principal-isolation-tests")
               (:file "autodig-persistence-tests")
               (:file "autodig-persistence-adversarial-tests")
  ...
  :perform (test-op (operation component)
             ...
             (funcall (find-symbol "RUN-AUTODIG-DELEGATED-REGISTRATION-TESTS" "QUASAR.TESTS"))
             (funcall (find-symbol "RUN-AUTODIG-PRINCIPAL-ISOLATION-TESTS" "QUASAR.TESTS"))
             (funcall (find-symbol "RUN-AUTODIG-PERSISTENCE-TESTS" "QUASAR.TESTS"))
             (funcall (find-symbol "RUN-AUTODIG-PERSISTENCE-ADVERSARIAL-TESTS" "QUASAR.TESTS"))
